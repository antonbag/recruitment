...
*/
function RecruitmentBuildRoute(&$query)
{
	// Fork system
	if (function_exists('RecruitmentCkBuildRoute')) return RecruitmentCkBuildRoute($query);
...
*/
function RecruitmentParseRoute($segments)
{
	// Fork system
	if (function_exists('RecruitmentCkParseRoute')) return RecruitmentCkParseRoute($segments);
...
*/
function RecruitmentParseSlug($slug, $model, $aliasKey)
{
	// Fork system
	if (function_exists('RecruitmentCkParseSlug')) return RecruitmentCkParseSlug($slug, $model, $aliasKey);
...
*/
function RecruitmentBuildSlug($id, $model, $aliasKey)
{
	// Fork system
	if (function_exists('RecruitmentCkBuildSlug')) return RecruitmentCkBuildSlug($id, $model, $aliasKey);
...
*/
function RecruitmentRouteConfig()
{
	// Fork system
	if (function_exists('RecruitmentCkRouteConfig')) return RecruitmentCkRouteConfig();
