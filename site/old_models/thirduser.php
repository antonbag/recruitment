...
* @subpackage	Classes
*/
class RecruitmentCkModelThirduser extends RecruitmentClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getTable($type = 'thirduser', $prefix = 'RecruitmentTable', $config = array())
	{
...
if (!class_exists('RecruitmentModelThirduser')){ class RecruitmentModelThirduser extends RecruitmentCkModelThirduser{} }
