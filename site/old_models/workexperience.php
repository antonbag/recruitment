...
* @subpackage	Classes
*/
class RecruitmentCkModelWorkexperience extends RecruitmentClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getTable($type = 'workexperience', $prefix = 'RecruitmentTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_recruitment.edit.workexperience.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('workexperience.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;
	...
	* @param	integer	$pk	The primary id key of the workexperience
	*
	* @return	void
	*/
	...
	{
		//FROM : Main table
		$query->from('#__recruitment_workexperiences AS a');
...
if (!class_exists('RecruitmentModelWorkexperience')){ class RecruitmentModelWorkexperience extends RecruitmentCkModelWorkexperience{} }
