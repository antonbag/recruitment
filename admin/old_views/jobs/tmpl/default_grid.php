		...
		<thead>
			<tr>
				...
				<th style="text-align:center">
					<?php echo JText::_("RECRUITMENT_FIELD_SHORT_DESCRIPTION"); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JText::_("RECRUITMENT_FIELD_PUBLISH_DATE"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("RECRUITMENT_FIELD_CLOSING_DATE"); ?>
				</th>
