...
* @subpackage	
*/
class RecruitmentCkClassControllerList extends JControllerAdmin
{
	/**
	...
	*/
	public function getModel($name = '', $prefix = 'RecruitmentModel', $config = array('ignore_request' => true))
	{
		if (empty($name))
		{
...
if (!class_exists('RecruitmentClassControllerList')){ class RecruitmentClassControllerList extends RecruitmentCkClassControllerList{} }
