...
* @subpackage	Class
*/
class RecruitmentCkClassView extends CkJView
{
	/**
	...
	*/
	...
	{
		$this->addTemplatePath(JPATH_RECRUITMENT . '/fork/views/' . $this->getName() . '/tmpl');
	}
...
if (!class_exists('RecruitmentClassView')){ class RecruitmentClassView extends RecruitmentCkClassView{} }
