...
/**
* Ajax Class for Recruitment.
*
* @package	Recruitment
* @subpackage	Class
*/
class RecruitmentCkClassAjax extends JObject
{
	/**
	...
	*/
	public static function responseHook($options = array(), $version)
	{
		...
		switch(strtoupper($options['renderExceptions']))
		{
			...
			case 'HTML':
				$return->transaction->htmlExceptions = RecruitmentClassView::renderMessages('HTML');
				break;

			case 'TEXT':
				$return->transaction->rawExceptions = RecruitmentClassView::renderMessages('TEXT');
				break;
			...
			default:
				...
				else
				{
					...
					$return->transaction->exceptions = RecruitmentClassView::renderMessages(null);
...
if (!class_exists('RecruitmentClassAjax')){ class RecruitmentClassAjax extends RecruitmentCkClassAjax{} }
