...
/**
* JLoader Class for Recruitment.
*
* @package	Recruitment
* @subpackage	Class
*/
class RecruitmentCkClassLoader extends JLoader
{
	/**
	...
	*/
	public static function setup($enablePsr = true, $enablePrefixes = true, $enableClasses = true, $enableComponentLoader = false)
	{
		...
		if ($enableComponentLoader)
			spl_autoload_register(array('RecruitmentClassLoader', 'load'));
	}
...
if (!class_exists('RecruitmentClassLoader')){ class RecruitmentClassLoader extends RecruitmentCkClassLoader{} }
