...
/**
* ORM Class for Recruitment.
*
* @package	Recruitment
* @subpackage	Class
*/
class RecruitmentCkClassModelOrm
{
	/**
	* Database.
	*
	...
	*/
	...
	{
		return new RecruitmentClassModelOrm($model);
	}
...
if (!class_exists('RecruitmentClassModelOrm')){ class RecruitmentClassModelOrm extends RecruitmentCkClassModelOrm{} }
