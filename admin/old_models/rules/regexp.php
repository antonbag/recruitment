...
* @subpackage	Form
*/
class RecruitmentCkFormRuleRegexp extends RecruitmentClassFormRule
{
	/**
...
if (!class_exists('JFormRuleRegexp')){ class JFormRuleRegexp extends RecruitmentCkFormRuleRegexp{} }
