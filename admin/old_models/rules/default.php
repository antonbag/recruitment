...
* @subpackage	Form
*/
class RecruitmentCkFormRuleDefault extends RecruitmentClassFormRule
{
	/**
...
if (!class_exists('JFormRuleDefault')){ class JFormRuleDefault extends RecruitmentCkFormRuleDefault{} }
