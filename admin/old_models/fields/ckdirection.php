...
* @subpackage	Form
*/
class RecruitmentCkFormFieldCkdirection extends RecruitmentClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkdirection')){ class JFormFieldCkdirection extends RecruitmentCkFormFieldCkdirection{} }
