...
* @subpackage	Form
*/
class RecruitmentCkFormFieldCkbtngroup extends RecruitmentClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkbtngroup')){ class JFormFieldCkbtngroup extends RecruitmentCkFormFieldCkbtngroup{} }
