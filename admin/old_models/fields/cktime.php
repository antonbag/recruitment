...
* @subpackage	Form
*/
class RecruitmentCkFormFieldCktime extends RecruitmentClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCktime')){ class JFormFieldCktime extends RecruitmentCkFormFieldCktime{} }
