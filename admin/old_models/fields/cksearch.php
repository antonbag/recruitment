...
* @subpackage	Form
*/
class RecruitmentCkFormFieldCksearch extends RecruitmentClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCksearch')){ class JFormFieldCksearch extends RecruitmentCkFormFieldCksearch{} }
