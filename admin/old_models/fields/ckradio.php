...
* @subpackage	Form
*/
class RecruitmentCkFormFieldCkradio extends RecruitmentClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkradio')){ class JFormFieldCkradio extends RecruitmentCkFormFieldCkradio{} }
