...
* @subpackage	Form
*/
class RecruitmentCkFormFieldCkcombo extends RecruitmentClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkcombo')){ class JFormFieldCkcombo extends RecruitmentCkFormFieldCkcombo{} }
