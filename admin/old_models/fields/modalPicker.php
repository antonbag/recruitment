...
* @subpackage	Form
*/
class RecruitmentCkFormFieldModalPicker extends JFormField
{
	/**
	* Extension name.
	*
	...
	*/
	protected function getSelectedLabel()
	{
		...
		$selectedItem = RecruitmentHelper::getData($model->getNameItem(), array(
...
if (!class_exists('JFormFieldModalPicker')){ class JFormFieldModalPicker extends RecruitmentCkFormFieldModalPicker{} }
