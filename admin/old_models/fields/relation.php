...
* @subpackage	Form
*/
class RecruitmentCkFormFieldRelation extends JFormFieldModel
{
	/**
	* The form field type.
	*
	...
	*/
	protected function getRelation()
	{
		...
		$model = CkJModel::getInstance($modelName, 'RecruitmentModel');
...
if (!class_exists('JFormFieldRelation')){ class JFormFieldRelation extends RecruitmentCkFormFieldRelation{} }
