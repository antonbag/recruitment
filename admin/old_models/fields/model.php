...
* @subpackage	Form
*/
class RecruitmentCkFormFieldModel extends JFormFieldGroupedList
{
	/**
	* Foreign Key Filter. 
	*
	...
	*/
	protected function getGroups()
	{
		...
		$listGroups = RecruitmentHelperForm::getElementGroups($this->element);
		...
		$items = RecruitmentHelperForm::getItems($this);
		...
		foreach($items as $item)
		{
			...
			{
				$val = RecruitmentHelper::parseValue($item, $labelKey);
				if ($val !== null)
	...
	*/
	protected function getOptions()
	{
		...
		if (!empty($items))
		foreach ($items as $item)
			$options[$item->$listKey] = RecruitmentHelper::parseValue($item, $labelKey);
	...
	*/
	public function prepareModel(&$model)
	{
		...
		$groups = RecruitmentHelperForm::getElementGroups($this->element);
...
if (!class_exists('JFormFieldModel')){ class JFormFieldModel extends RecruitmentCkFormFieldModel{} }
