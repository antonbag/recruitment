...
* @subpackage	Form
*/
class RecruitmentCkFormFieldCksort extends RecruitmentClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCksort')){ class JFormFieldCksort extends RecruitmentCkFormFieldCksort{} }
