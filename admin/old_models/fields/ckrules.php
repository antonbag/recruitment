...
* @subpackage	Form
*/
class RecruitmentCkFormFieldCkrules extends RecruitmentClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkrules')){ class JFormFieldCkrules extends RecruitmentCkFormFieldCkrules{} }
