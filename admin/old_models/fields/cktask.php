...
* @subpackage	Form
*/
class RecruitmentCkFormFieldCktask extends RecruitmentClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCktask')){ class JFormFieldCktask extends RecruitmentCkFormFieldCktask{} }
