...
* @subpackage	Form
*/
class RecruitmentCkFormFieldCkcbrow extends RecruitmentClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkcbrow')){ class JFormFieldCkcbrow extends RecruitmentCkFormFieldCkcbrow{} }
