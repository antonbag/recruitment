...
* @subpackage	Form
*/
class RecruitmentCkFormFieldAjax extends JFormField
{
	/**
	* Groups cache.
	*
	...
	protected function getConfig()
	{
		...
		switch($plugin)
		{
			...
			case 'field':
				...
				$config['groups'] = RecruitmentHelperForm::getElementGroups($this->element);
	...
	*/
	protected function getModel($model = null)
	{
		...
		return RecruitmentHelper::componentModel($model);
	}
...
if (!class_exists('JFormFieldAjax')){ class JFormFieldAjax extends RecruitmentCkFormFieldAjax{} }
