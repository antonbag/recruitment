...
* @subpackage	Classes
*/
class RecruitmentCkModelProgrammes extends RecruitmentClassModelList
{
	/**
	* Default item layout.
	*
	* @var array
	*/
	public $itemDefaultLayout = 'programme';
...
if (!class_exists('RecruitmentModelProgrammes')){ class RecruitmentModelProgrammes extends RecruitmentCkModelProgrammes{} }
