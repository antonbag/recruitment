...
class RecruitmentCkHelperEnum
{
	...
	* @param	string	$enumName	Name of the enumeration
	*
	* @return	object	Enumeration instance (RecruitmentHelperEnum)
	*/
	public static function getInstance($enumName)
	{
		...
		$enumeration = new RecruitmentHelperEnum($enumName);
...
if (!class_exists('RecruitmentHelperEnum')){ class RecruitmentHelperEnum extends RecruitmentCkHelperEnum{} }
