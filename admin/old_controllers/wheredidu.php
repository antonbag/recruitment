...
class RecruitmentCkControllerWheredidu extends RecruitmentClassControllerItem
{
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'default.add':
				$this->applyRedirection($result, array(
					'stay',
					'com_recruitment.wheredidu.wheredidu'
				), array(
	...
	*/
	public function cancel($key = null)
	{
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'wheredidu.cancel':
				$this->applyRedirection($result, array(
					'stay',
					'com_recruitment.wheredidus.default'
				), array(
					'cid[]' => null
				));
				break;
	...
	*/
	protected function getLayout($default = null)
	{
		...
		return $jinput->get('layout', 'wheredidu', 'CMD');
	}
	...
	*/
	public function save($key = null, $urlVar = null)
	{
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			...
			case 'wheredidu.apply':
				$this->applyRedirection($result, array(
					'stay',
					'com_recruitment.wheredidu.wheredidu'
				), array(
					'cid[]' => $model->getState('wheredidu.id')
				));
				break;
